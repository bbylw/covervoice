---
name: covervoice
description: 映声 — 生成"电子杂志 × 电子墨水"风格的 9:16 竖版短视频封面，自动合成 TTS 配音并输出 MP4 视频。含 WebGL 流体背景、六种封面布局、edge-tts 语音生成、FFmpeg 视频合成。当用户需要制作短视频、生成带配音的封面视频、或提到"短视频"、"封面"、"配音"、"TTS"、"9:16"、"映声"时使用。
---
